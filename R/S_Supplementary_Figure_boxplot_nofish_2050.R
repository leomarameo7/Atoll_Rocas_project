...
library(tidyverse)
#####Read data######
#read data from "processed" folder, scenario 2050 and for NO fish species 
d <- read_csv("data/processed/processed_data_figure_box-plot_year_2050_nofish.csv", 
              col_types = cols())
...
median_statusquo$species <- factor(median_statusquo$species,
                                   levels = c("Sea birds","Turtles","Cephalopoda",
                                              ...
                                              "Siderastrea stellata","Zooplankton",
                                              "Phytoplankton","Digenea simplex","Other algal turf"))
##### boxplot for the 2050 year and NOfish species ####
...
return(print(p))
####Saving figure####
ggsave(filename = "supplementary_figure_boxplot_NOfish_2050", plot = p, path = "outputs_results/figures/",
